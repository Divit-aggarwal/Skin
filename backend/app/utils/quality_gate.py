"""Quality gate for image validation.

Phase 1: runs directly in the backend process.
Phase 2: replace with httpx call to the inference service.
"""
import os
...
def count_faces(image_array: np.ndarray) -> int:
    # Lazy import — mediapipe is heavy; tests mock validate_image entirely.
